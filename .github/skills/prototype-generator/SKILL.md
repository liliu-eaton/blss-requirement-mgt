...
description: "Generate an interactive HTML prototype from a Jira requirement and attached UI screenshots for BLSS products. Use when: prototyping new features, UI mockup, interactive wireframe, Server Admin prototype, BLSS product page prototype, UX design preview, HTML prototype generation."
...
- Prototyping new BLSS product features as interactive HTML
- Creating UI mockups from Jira requirements
- Building interactive wireframes for Server Admin, DCPM, EPMS, Distributed IT, or Brightlayer Power
- Previewing UX designs before development
- Generating clickable prototypes from screenshots + requirements
...
Refer to [UI Patterns Reference](./references/ui-patterns.md) for standard component patterns (Configuration Card, Data Table, Confirmation Modal).
